...
def get_ai_future(name):
    prompt = f"Imagine a funny and bizarre future yet motivational prediction in simple english and  a bit telugu for an indian person named {name}. Make it witty and creative!"
